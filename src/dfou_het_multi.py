...
def run_misspecification_test(n_runs=3):
    ...
    df_metrics.to_csv("metrics_summary_het_multi.csv", index=False)
    torch.save(parameter_archive, "parameter_archive_het_multi.pt")
    print("\n[+] Saved extensive metrics to 'metrics_summary_het_multi.csv' and matrices to 'parameter_archive_het_multi.pt'")
