...
if __name__ == "__main__":
    ...
    parser.add_argument("--sims", type=int, default=200, help="Number of Monte Carlo simulations to run")
    ...
    tasks = []
    for run_id in range(1, args.sims + 1):
        tasks.append({
            'run_id': run_id,
    ...
    print(f"\nAll parallel executions finished. ({successful_runs}/{args.sims} successful)")
    final_table = generate_simulation_table(scenario=scenario_to_run, model_name=model_name)